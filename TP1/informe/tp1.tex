...
\section{Simulacion}
Simulacion del ciruito en software de simulacion LTspice, en el modo operating point.
\includegraphics[width=1\textwidth]{imagenes/simulacion_CC.png}\par
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    ...
    \hline
    \multirow{3}{*}{Tension[V]} & Análisis   &        10         &         8,346       &      1,623          &       1,623         \\
    \cline{2-6}
                             & Simulación &        10         &        8,34        &        1,623        &        1,623        \\
    \cline{2-6}
                             & Medición   &      9,97           &          8,34      &       1,61         &        1,62        \\
    \hline
    \multirow{3}{*}{Corriente[$\mu$A]} & Análisis   &      837,661         &        837,661        &       345,402         &         497,936       \\
    \cline{2-6}
